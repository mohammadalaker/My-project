                ...
                >
                  ...
                  >
                    ...
                    <div className="p-4 flex-1 flex flex-col min-h-[140px]">
                      ...
                      <p className="mt-1.5 text-slate-500 text-sm shrink-0"><span className="font-medium">الكمية:</span> <span dir="ltr" lang="en" className={getStockStatus(item) === 'موجود' ? 'text-emerald-600 font-semibold' : 'text-slate-500'}>{item.stock != null && item.stock !== '' ? Number(item.stock) : '—'}</span></p>
                    </div>
                  </div>

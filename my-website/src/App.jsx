          ...
          >
            ...
            <div className="custom-scrollbar min-h-0 flex-1 space-y-4 overflow-y-auto px-5 pb-4 pt-4">
              ...
              <div className="space-y-3 pt-2 border-t border-slate-100">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <label className={`flex items-center gap-3 cursor-pointer rounded-xl border-2 p-3 transition-all font-bold text-sm ${orderInfo.paymentMethod === 'Cash' ? 'border-indigo-500 bg-indigo-50 text-indigo-700' : 'border-slate-200 bg-white text-slate-600 hover:border-indigo-200'}`}>
                    <input
                      type="radio"
                  ...
                  <label className={`flex items-center gap-3 cursor-pointer rounded-xl border-2 p-3 transition-all font-bold text-sm ${orderInfo.paymentMethod === 'Checks' ? 'border-indigo-500 bg-indigo-50 text-indigo-700' : 'border-slate-200 bg-white text-slate-600 hover:border-indigo-200'}`}>
                    <input
                      type="radio"
                      name="paymentMethodOrderSubmitModal"
                      value="Checks"
                  ...
                  <label className={`flex items-center gap-3 cursor-pointer rounded-xl border-2 p-3 transition-all font-bold text-sm ${orderInfo.paymentMethod === 'Credit' ? 'border-indigo-500 bg-indigo-50 text-indigo-700' : 'border-slate-200 bg-white text-slate-600 hover:border-indigo-200'}`}>
                    <input
                      type="radio"
                      name="paymentMethodOrderSubmitModal"
                      value="Credit"
                  ...
                  <label className={`flex items-center gap-3 cursor-pointer rounded-xl border-2 p-3 transition-all font-bold text-sm ${orderInfo.paymentMethod === 'Installment' ? 'border-indigo-500 bg-indigo-50 text-indigo-700' : 'border-slate-200 bg-white text-slate-600 hover:border-indigo-200'}`}>
                    <input
                      type="radio"
                      name="paymentMethodOrderSubmitModal"
                      value="Installment"
